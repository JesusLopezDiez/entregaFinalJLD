...
public class Furgonetas {
	...
	private List<CargaFurgonetas> carga;
	
	
	
	public Furgonetas(Integer id, String matricula, String rutaDesde, String rutaHasta, String fechaAlta,
			String fechaBaja) {
		super();
		this.id = id;
	...
	public List<CargaFurgonetas> getCarga() {
		return carga;
	}
	public void setCarga(List<CargaFurgonetas> carga) {
		this.carga = carga;
	}
