...
public class VIncidenciaD extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public VIncidenciaD(String nenvio,JComboBox comboClasificarEnvios) {
		setIconImage(Toolkit.getDefaultToolkit().getImage(VIncidenciaD.class.getResource("/img/logo.png")));
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						String respuestas = sp.altaEstado(comboBox.getSelectedItem().toString(), nenvio,"Incidencia");
